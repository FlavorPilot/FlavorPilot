...
import type { SavedDish } from "@tastecraft/flavor-engine";
...
export function LibraryClient({
  ...
  useEffect(() => {
    refresh();
    window.addEventListener("tastecraft:dishes-updated", refresh);
    return () => window.removeEventListener("tastecraft:dishes-updated", refresh);
  }, []);
