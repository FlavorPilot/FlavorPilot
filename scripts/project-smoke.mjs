...
assertCheck("project version is 0.2.0", rootPackage.version === "0.2.0", rootPackage.version);
assertCheck(
...
for (const packageFile of packageFiles) {
  ...
  for (const dependencyName of ["@tastecraft/contracts", "@tastecraft/flavor-engine"]) {
    const version = manifest.dependencies?.[dependencyName];
    if (version !== undefined && version !== "0.2.0") {
...
assertCheck(
  ...
  flavorIndex.includes('export * from "@tastecraft/contracts"')
);
