...
import { DatabaseService, type TasteCraftDatabase } from "../database/database.service";
import {
  dishes,
  dishItems,
  dishVersions,
...
type DishMutationExecutor = Pick<TasteCraftDatabase, "delete" | "insert">;
