...
const en: Dictionary = {
  meta: {
    title: "TasteCraft — live flavor simulator for chefs",
    description:
      "Build a dish, model its sensory balance, and see what to add, remove or adjust."
  },
  brand: { name: "TasteCraft", descriptor: "Flavor simulator" },
  nav: {
    builder: "Builder",
    discover: "Discover",
    library: "My dishes",
  ...
  home: {
    ...
    subtitle:
      "TasteCraft models ingredient compatibility, quantities, preparation, texture and balance in real time — then explains what to change and why.",
...
const uk: Dictionary = {
  meta: {
    title: "TasteCraft — живий симулятор смаку для кухарів",
    description:
      "Створюйте страву, моделюйте її сенсорний баланс і бачте, що додати, прибрати або змінити."
  },
  brand: { name: "TasteCraft", descriptor: "Симулятор смаку" },
  nav: {
    builder: "Конструктор",
    discover: "Огляд",
    library: "Мої страви",
  ...
  home: {
    ...
    subtitle:
      "TasteCraft у реальному часі моделює сумісність продуктів, кількість, обробку, текстуру й баланс — а потім пояснює, що змінити і чому.",
