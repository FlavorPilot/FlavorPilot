...
import { publicDishSeeds, ingredientById } from "@flavorpilot/flavor-engine";
import { analyzeDish } from "@flavorpilot/flavor-engine";
import type { DishGoal, SavedDish } from "@flavorpilot/flavor-engine";
import type { DishResponse } from "@flavorpilot/contracts";
...
export function DiscoverClient({
  ...
  useEffect(() => {
    ...
    load();
    window.addEventListener("flavorpilot:dishes-updated", load);
    return () => window.removeEventListener("flavorpilot:dishes-updated", load);
  }, []);
